...
// In a developer lib of the Cray compiler (i.e. a compiler built by a
...
//
// If we are using a developer lib of the compiler, we want to use the
...
//
// So, that is how we detect if we are using a developer lib of the Cray
// compiler.
