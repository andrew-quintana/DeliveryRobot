...
BOOST_AUTO_LINK_TAGGED:   Specifies that we link to libraries built with the --layout=tagged option.
                          ...
                          the compiler name and version, or the Boost version.  Just the lib options.
...
BOOST_LIB_RT_OPT:     A suffix that indicates the runtime library used,
                      ...
                      d      debug lib (release if not present).
                      p      STLport lib.
                      n      STLport lib without its IOStreams.
...
#  error "Incompatible lib options"
#endif
//
