...
/// \brief Container adaptor to lib a type that is compliant to the concept of a container.
...
/// \brief Container Adaptor toolbox, easy way to lib new containers from existing ones.
