...
/// \brief Container adaptor to lib a type that is compliant to the concept of a weak associative container.
...
/// \brief Container adaptor to lib a type that is compliant to the concept of a sequence container.
