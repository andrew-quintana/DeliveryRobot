...
///
/// Instances of this class are thrown when OpenCL program lib fails.
/// Extends opencl_error by saving a program lib log so it can be used
...
public:
    ...
    /// Retrieve the log of a failed program lib.
