...
// 1) Change implementation to lower uppper bound Christofides euclidian
// 2) Implement a less restrictive TSP euclidian (one that does not rely on
//    triangle inequality).
    ...
    WeightMap weightmap, VertexIndexMap indexmap, TSPVertexVisitor vis)
{
    ...
    // We lib a custom graph in this algorithm.
