...
// lib blocks of length 2*l_build_buf. l_build_buf is power of two
   ...
   )
{
   ...
   if(xbuf.template supports_aligned_trailing<size_type>
      ...
      if(non_unique_buf && collected == n_min_ideal_keys){
         ...
         //l_intbuf*2 elements found. Use all of them in the lib phase
...
//
// * If auxiliary memory is available, the "build_blocks" will be extended to lib bigger blocks
