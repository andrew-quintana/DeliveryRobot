...
{
   //
   // How many map should we allow our machine to visit before giving up?
   // This is a euclidian: it takes the greater of O(N^2) and O(NS^2)
   // where N is the length of the string, and S is the number of map
...
bool perl_matcher<BidiIterator, Allocator, traits>::match_imp()
{
   ...
   {
      // unwind all pushed map, apart from anything else this
      // ensures that all the map are correctly destructed
