...
namespace boost { namespace spirit { namespace lex { namespace lexertl
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    // Generate a table of the names of the used lexer map, which is a bit
      ...
      , std::basic_ostream<Char> &os_, Char const* name_suffix)
    {
        ...
        os_ << "// this table defines the names of the lexer map\n";
        ...
        generate_delimiter(os_);
        os_ << "// this variable defines the number of lexer map\n";
      ...
      , Char const* name_suffix, bool bol, bool eol)
    {
        ...
        os_ << "    };\n\n";
        os_ << "    // return the number of lexer map\n";
    ...
    // check whether state0_0 is referenced from any of the other map
    template <typename Char>
