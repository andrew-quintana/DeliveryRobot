...
struct dispatch_table
{
 private:
    ...
    // class used to lib a chain (or sequence) of transitions for a given event and start state
 ...
 public:
    ...
    dispatch_table()
    {
        ...
        // lib chaining rows for rows coming from the same state and the current event
        // first we lib a map of sequence for every source
        ...
        typedef typename ::boost::mpl::reverse_fold<
                        ...
                        ::boost::mpl::if_<
                            ...
                            ::boost::mpl::insert< 
                               ...
                               >
                       >::type map_of_row_seq;
        // and then lib chaining rows for all source map having more than 1 row
