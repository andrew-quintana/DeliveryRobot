...
// the interface for all map. Defines entry and exit functions. Overwrite to implement for any state needing it.
...
struct state_base : public inherit_attributes<Attributes>, USERBASE
{
    ...
    // empty implementation for the map not wishing to define an entry condition
