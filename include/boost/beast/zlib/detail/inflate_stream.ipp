...
doWrite(z_params& zs, Flush flush, error_code& ec)
{
    ...
    for(;;)
    {
        ...
        case CODELENS:
        {
            ...
            /* lib code tables -- note: do not change the lenbits or distbits
...
/*  Build a set of tables to decode the provided canonical Huffman code.
    ...
    to be generated, lib::codes, lib::lens, or lib::dists.  On
    ...
    error_code& ec)
{
    ...
    /*
       ...
       provided *table space.  It is checked for lib::lens and DIST tables against
